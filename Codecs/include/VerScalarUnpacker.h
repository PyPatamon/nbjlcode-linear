#ifndef CODECS_VERSCALARUNPACKER_H_
#define CODECS_VERSCALARUNPACKER_H_

// 0-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c0(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	if (!IsRiceCoding) { // For NewPFor and OptPFor.
		memset(out, 0, sizeof(uint32_t) * 128);
	}
	else { // For Rice and OptRice.
		memcpy(out, quotient, sizeof(uint32_t) * 128);
	}
}

// 1-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c1(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x01 ;
	out[1] = ( in[1] >> 0 ) & 0x01 ;
	out[2] = ( in[2] >> 0 ) & 0x01 ;
...
// 2-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c2(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x03 ;
	out[1] = ( in[1] >> 0 ) & 0x03 ;
	out[2] = ( in[2] >> 0 ) & 0x03 ;
...
// 3-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c3(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x07 ;
	out[1] = ( in[1] >> 0 ) & 0x07 ;
	out[2] = ( in[2] >> 0 ) & 0x07 ;
...
// 4-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c4(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x0f ;
	out[1] = ( in[1] >> 0 ) & 0x0f ;
	out[2] = ( in[2] >> 0 ) & 0x0f ;
...
// 5-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c5(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x1f ;
	out[1] = ( in[1] >> 0 ) & 0x1f ;
	out[2] = ( in[2] >> 0 ) & 0x1f ;
...
// 6-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c6(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x3f ;
	out[1] = ( in[1] >> 0 ) & 0x3f ;
	out[2] = ( in[2] >> 0 ) & 0x3f ;
...
// 7-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c7(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x7f ;
	out[1] = ( in[1] >> 0 ) & 0x7f ;
	out[2] = ( in[2] >> 0 ) & 0x7f ;
...
// 8-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c8(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0xff ;
	out[1] = ( in[1] >> 0 ) & 0xff ;
	out[2] = ( in[2] >> 0 ) & 0xff ;
...
// 9-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c9(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x01ff ;
	out[1] = ( in[1] >> 0 ) & 0x01ff ;
	out[2] = ( in[2] >> 0 ) & 0x01ff ;
...
// 10-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c10(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x03ff ;
	out[1] = ( in[1] >> 0 ) & 0x03ff ;
	out[2] = ( in[2] >> 0 ) & 0x03ff ;
...
// 11-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c11(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x07ff ;
	out[1] = ( in[1] >> 0 ) & 0x07ff ;
	out[2] = ( in[2] >> 0 ) & 0x07ff ;
...
// 12-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c12(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x0fff ;
	out[1] = ( in[1] >> 0 ) & 0x0fff ;
	out[2] = ( in[2] >> 0 ) & 0x0fff ;
...
// 13-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c13(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x1fff ;
	out[1] = ( in[1] >> 0 ) & 0x1fff ;
	out[2] = ( in[2] >> 0 ) & 0x1fff ;
...
// 14-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c14(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x3fff ;
	out[1] = ( in[1] >> 0 ) & 0x3fff ;
	out[2] = ( in[2] >> 0 ) & 0x3fff ;
...
// 15-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c15(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x7fff ;
	out[1] = ( in[1] >> 0 ) & 0x7fff ;
	out[2] = ( in[2] >> 0 ) & 0x7fff ;
...
// 16-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c16(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0xffff ;
	out[1] = ( in[1] >> 0 ) & 0xffff ;
	out[2] = ( in[2] >> 0 ) & 0xffff ;
...
// 17-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c17(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 18-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c18(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 19-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c19(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 20-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c20(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 21-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c21(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 22-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c22(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 23-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c23(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 24-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c24(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 25-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c25(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 26-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c26(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 27-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c27(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 28-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c28(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 29-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c29(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 30-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c30(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 31-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c31(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 32-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalunpack_c32(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 1-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c1(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 2-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c2(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 3-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c3(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 4-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c4(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 5-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c5(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 6-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c6(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 7-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c7(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 8-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c8(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 9-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c9(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 10-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c10(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 11-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c11(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 12-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c12(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 13-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c13(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 14-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c14(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 15-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c15(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 16-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c16(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 17-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c17(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 18-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c18(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 19-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c19(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 20-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c20(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 21-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c21(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 22-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c22(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 23-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c23(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 24-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c24(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 25-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c25(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 26-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c26(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 27-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c27(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 28-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c28(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 29-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c29(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 30-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c30(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 31-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c31(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[1] = in[1] << 0 ;
	out[2] = in[2] << 0 ;
...
// 32-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpackwithoutmask_c32(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 1-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c1(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x01 ) << 0 ;
	out[1] = ( in[1] & 0x01 ) << 0 ;
	out[2] = ( in[2] & 0x01 ) << 0 ;
...
// 2-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c2(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x03 ) << 0 ;
	out[1] = ( in[1] & 0x03 ) << 0 ;
	out[2] = ( in[2] & 0x03 ) << 0 ;
...
// 3-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c3(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x07 ) << 0 ;
	out[1] = ( in[1] & 0x07 ) << 0 ;
	out[2] = ( in[2] & 0x07 ) << 0 ;
...
// 4-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c4(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x0f ) << 0 ;
	out[1] = ( in[1] & 0x0f ) << 0 ;
	out[2] = ( in[2] & 0x0f ) << 0 ;
...
// 5-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c5(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x1f ) << 0 ;
	out[1] = ( in[1] & 0x1f ) << 0 ;
	out[2] = ( in[2] & 0x1f ) << 0 ;
...
// 6-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c6(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x3f ) << 0 ;
	out[1] = ( in[1] & 0x3f ) << 0 ;
	out[2] = ( in[2] & 0x3f ) << 0 ;
...
// 7-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c7(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x7f ) << 0 ;
	out[1] = ( in[1] & 0x7f ) << 0 ;
	out[2] = ( in[2] & 0x7f ) << 0 ;
...
// 8-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c8(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0xff ) << 0 ;
	out[1] = ( in[1] & 0xff ) << 0 ;
	out[2] = ( in[2] & 0xff ) << 0 ;
...
// 9-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c9(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x01ff ) << 0 ;
	out[1] = ( in[1] & 0x01ff ) << 0 ;
	out[2] = ( in[2] & 0x01ff ) << 0 ;
...
// 10-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c10(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x03ff ) << 0 ;
	out[1] = ( in[1] & 0x03ff ) << 0 ;
	out[2] = ( in[2] & 0x03ff ) << 0 ;
...
// 11-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c11(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x07ff ) << 0 ;
	out[1] = ( in[1] & 0x07ff ) << 0 ;
	out[2] = ( in[2] & 0x07ff ) << 0 ;
...
// 12-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c12(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x0fff ) << 0 ;
	out[1] = ( in[1] & 0x0fff ) << 0 ;
	out[2] = ( in[2] & 0x0fff ) << 0 ;
...
// 13-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c13(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x1fff ) << 0 ;
	out[1] = ( in[1] & 0x1fff ) << 0 ;
	out[2] = ( in[2] & 0x1fff ) << 0 ;
...
// 14-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c14(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x3fff ) << 0 ;
	out[1] = ( in[1] & 0x3fff ) << 0 ;
	out[2] = ( in[2] & 0x3fff ) << 0 ;
...
// 15-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c15(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x7fff ) << 0 ;
	out[1] = ( in[1] & 0x7fff ) << 0 ;
	out[2] = ( in[2] & 0x7fff ) << 0 ;
...
// 16-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c16(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0xffff ) << 0 ;
	out[1] = ( in[1] & 0xffff ) << 0 ;
	out[2] = ( in[2] & 0xffff ) << 0 ;
...
// 17-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c17(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 18-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c18(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 19-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c19(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 20-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c20(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 21-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c21(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 22-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c22(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 23-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c23(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 24-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c24(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 25-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c25(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 26-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c26(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 27-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c27(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 28-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c28(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 29-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c29(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 30-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c30(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 31-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c31(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 32-bit
template <bool IsRiceCoding>
void VerUnpacker<Scalar, IsRiceCoding>::verticalpack_c32(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	memcpy(out, in, 128 * sizeof(uint32_t));
}

#endif /* CODECS_VERSCALARUNPACKER_H_ */
