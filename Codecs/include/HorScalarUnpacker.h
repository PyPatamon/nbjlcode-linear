#ifndef CODECS_HORSCALARUNPACKER_H_
#define CODECS_HORSCALARUNPACKER_H_

// 0-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c0(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	if (!IsRiceCoding) { // For NewPFor and OptPFor.
		memset(out, 0, sizeof(uint32_t) * 64);
	}
	else { // For Rice and OptRice.
		memcpy(out, quotient, sizeof(uint32_t) * 64);
	}
}

// 1-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c1(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x01 ;
	out[1] = ( in[0] >> 1 ) & 0x01 ;
	out[2] = ( in[0] >> 2 ) & 0x01 ;
...
// 2-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c2(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x03 ;
	out[1] = ( in[0] >> 2 ) & 0x03 ;
	out[2] = ( in[0] >> 4 ) & 0x03 ;
...
// 3-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c3(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x07 ;
	out[1] = ( in[0] >> 3 ) & 0x07 ;
	out[2] = ( in[0] >> 6 ) & 0x07 ;
...
// 4-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c4(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x0f ;
	out[1] = ( in[0] >> 4 ) & 0x0f ;
	out[2] = ( in[0] >> 8 ) & 0x0f ;
...
// 5-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c5(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x1f ;
	out[1] = ( in[0] >> 5 ) & 0x1f ;
	out[2] = ( in[0] >> 10 ) & 0x1f ;
...
// 6-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c6(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x3f ;
	out[1] = ( in[0] >> 6 ) & 0x3f ;
	out[2] = ( in[0] >> 12 ) & 0x3f ;
...
// 7-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c7(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x7f ;
	out[1] = ( in[0] >> 7 ) & 0x7f ;
	out[2] = ( in[0] >> 14 ) & 0x7f ;
...
// 8-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c8(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0xff ;
	out[1] = ( in[0] >> 8 ) & 0xff ;
	out[2] = ( in[0] >> 16 ) & 0xff ;
...
// 9-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c9(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x01ff ;
	out[1] = ( in[0] >> 9 ) & 0x01ff ;
...
// 10-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c10(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x03ff ;
...
// 11-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c11(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x07ff ;
...
// 12-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c12(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x0fff ;
...
// 13-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c13(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x1fff ;
...
// 14-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c14(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x3fff ;
...
// 15-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c15(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0x7fff ;
...
// 16-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c16(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	out[0] = ( in[0] >> 0 ) & 0xffff ;
	out[1] = ( in[0] >> 16 ) ;
...
// 17-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c17(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 18-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c18(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 19-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c19(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 20-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c20(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 21-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c21(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 22-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c22(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 23-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c23(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 24-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c24(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 25-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c25(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 26-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c26(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 27-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c27(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 28-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c28(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 29-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c29(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 30-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c30(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 31-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c31(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
...
// 32-bit
template <bool IsRiceCoding>
void HorUnpacker<Scalar, IsRiceCoding>::horizontalunpack_c32(uint32_t *  __restrict__  out,
		const uint32_t *  __restrict__  in) {
	memcpy(out, in, sizeof(uint32_t) * 64);
}

// 1-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c1(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 1 ;
	out[0] |= in[2] << 2 ;
...
// 2-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c2(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 2 ;
	out[0] |= in[2] << 4 ;
...
// 3-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c3(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 3 ;
	out[0] |= in[2] << 6 ;
...
// 4-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c4(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 4 ;
	out[0] |= in[2] << 8 ;
...
// 5-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c5(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 5 ;
	out[0] |= in[2] << 10 ;
...
// 6-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c6(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 6 ;
	out[0] |= in[2] << 12 ;
...
// 7-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c7(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 7 ;
	out[0] |= in[2] << 14 ;
...
// 8-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c8(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 8 ;
	out[0] |= in[2] << 16 ;
...
// 9-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c9(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 9 ;
	out[0] |= in[2] << 18 ;
...
// 10-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c10(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 10 ;
	out[0] |= in[2] << 20 ;
...
// 11-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c11(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 11 ;
	out[0] |= in[2] << 22 ;
...
// 12-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c12(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 12 ;
	out[0] |= in[2] << 24 ;
...
// 13-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c13(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 13 ;
	out[0] |= in[2] << 26 ;
...
// 14-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c14(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 14 ;
	out[0] |= in[2] << 28 ;
...
// 15-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c15(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 15 ;
	out[0] |= in[2] << 30 ;
...
// 16-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c16(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 16 ;
...
// 17-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c17(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 17 ;
...
// 18-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c18(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 18 ;
...
// 19-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c19(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 19 ;
...
// 20-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c20(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 20 ;
...
// 21-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c21(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 21 ;
...
// 22-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c22(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 22 ;
...
// 23-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c23(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 23 ;
...
// 24-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c24(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 24 ;
...
// 25-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c25(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 25 ;
...
// 26-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c26(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 26 ;
...
// 27-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c27(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 27 ;
...
// 28-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c28(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 28 ;
...
// 29-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c29(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 29 ;
...
// 30-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c30(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 30 ;
...
// 31-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c31(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = in[0] << 0 ;
	out[0] |= in[1] << 31 ;
...
// 32-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpackwithoutmask_c32(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 1-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c1(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x01 ) << 0 ;
	out[0] |= ( in[1] & 0x01 ) << 1 ;
	out[0] |= ( in[2] & 0x01 ) << 2 ;
...
// 2-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c2(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x03 ) << 0 ;
	out[0] |= ( in[1] & 0x03 ) << 2 ;
	out[0] |= ( in[2] & 0x03 ) << 4 ;
...
// 3-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c3(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x07 ) << 0 ;
	out[0] |= ( in[1] & 0x07 ) << 3 ;
	out[0] |= ( in[2] & 0x07 ) << 6 ;
...
// 4-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c4(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x0f ) << 0 ;
	out[0] |= ( in[1] & 0x0f ) << 4 ;
	out[0] |= ( in[2] & 0x0f ) << 8 ;
...
// 5-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c5(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x1f ) << 0 ;
	out[0] |= ( in[1] & 0x1f ) << 5 ;
	out[0] |= ( in[2] & 0x1f ) << 10 ;
...
// 6-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c6(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x3f ) << 0 ;
	out[0] |= ( in[1] & 0x3f ) << 6 ;
	out[0] |= ( in[2] & 0x3f ) << 12 ;
...
// 7-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c7(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x7f ) << 0 ;
	out[0] |= ( in[1] & 0x7f ) << 7 ;
	out[0] |= ( in[2] & 0x7f ) << 14 ;
...
// 8-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c8(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0xff ) << 0 ;
	out[0] |= ( in[1] & 0xff ) << 8 ;
	out[0] |= ( in[2] & 0xff ) << 16 ;
...
// 9-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c9(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x01ff ) << 0 ;
	out[0] |= ( in[1] & 0x01ff ) << 9 ;
...
// 10-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c10(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x03ff ) << 0 ;
...
// 11-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c11(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x07ff ) << 0 ;
...
// 12-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c12(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x0fff ) << 0 ;
...
// 13-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c13(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x1fff ) << 0 ;
...
// 14-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c14(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x3fff ) << 0 ;
...
// 15-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c15(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0x7fff ) << 0 ;
...
// 16-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c16(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	out[0] = ( in[0] & 0xffff ) << 0 ;
	out[0] |= in[1] << 16 ;
...
// 17-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c17(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 18-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c18(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 19-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c19(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 20-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c20(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 21-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c21(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 22-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c22(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 23-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c23(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 24-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c24(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 25-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c25(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 26-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c26(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 27-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c27(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 28-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c28(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 29-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c29(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 30-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c30(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 31-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c31(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
...
// 32-bit
template <typename InstructionSet, bool IsRiceCoding>
void HorUnpackerBase<InstructionSet, IsRiceCoding>::horizontalpack_c32(uint32_t *  __restrict__  out,
		const uint32_t * __restrict__  in) {
	memcpy(out, in, 64 * sizeof(uint32_t));
}

#endif /* CODECS_HORSCALARUNPACKER_H_ */
